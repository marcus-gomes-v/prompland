...
export default function Productivity() {
  const pageTitle = "AI-Enhanced Productivity - Prompland";
  const pageDescription = "Discover AI-enhanced productivity tools to streamline your tasks, stay organized, and achieve more in less time.";
              ...
              <div className="lg:col-span-2">
                <div className="prose prose-indigo prose-lg text-gray-500">
                  ...
                  <p className="mt-6 text-md lg:text-lg text-gray-800 text-justify">
                    Discover AI-enhanced productivity tools to streamline your tasks, stay organized, and achieve more in less time.
                  </p>
                </div>
              </div>
            </div>
