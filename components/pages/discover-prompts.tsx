...
import CreatedPromptsTable from "../tables/created-prompts";
import DiscoverPromptsList from "../lists/discover-prompts";



export default function DiscoverPrompts({ user }: { user: iUser }) {
