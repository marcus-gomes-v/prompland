                  ...
                  <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                      <button
                        ...
                        type="button"
                        className="inline-flex items-center justify-center rounded-md border border-transparent bg-vibrant-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-vibrant-blue-700 focus:outline-none focus:ring-2 focus:ring-vibrant-blue-500 focus:ring-offset-2 sm:w-auto"
                      >
                        New Project
                      </button>
                    </div>
